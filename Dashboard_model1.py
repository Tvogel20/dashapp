...
app.layout = html.Div([
    dcc.Tabs([
        dcc.Tab(label='GDP Forecast, Fed Rate & CPI Monitor (click me)', style=tab_style,selected_style = tab_selected_style, children=[
            html.Div([
                      html.Div(children=[    
                        html.Br(),
                        html.H3('Recession Monitor Readme'),
                        html.Div(children='''
                            You can use the top two tabs (black and white) to navigate between the recession monitor and the GDP forecast. You can download most data and charts by clicking on the download button on the top right of each chart/table.
                        '''),
                        html.Div(children='''
                            For Questions or Comments please contact me at: tom.vogel22@imperial.ac.uk
                        ''')
